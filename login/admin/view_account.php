...
<body>
	  ...
	  <a href="add_account.php">Insert a Data</a><br><br>
	  ...
	  <a href="logout.php">logout</a><br><br>
	       <table align="center" width="1000" border="4">
		      ...
		      <tr>
				  ...
				  <h1 align="center">View all the  Account Record</h1>
...
<?php
 ...
 ?>
		   ...
		   <td align="center"><a href='delete_account.php?del=<?php echo $id;?>'> Delete</a></td>
