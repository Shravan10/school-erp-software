...
<body>
	  ...
	  <a href="add_hostel.php">Insert a Data</a><br><br>
	  ...
	  <a href="logout.php">logout</a><br><br>
	       <table align="center" width="1000" border="4">
		      ...
		      <tr>
				  ...
				  <h1 align="center">View all the  Hostel Manager Record</h1>
...
<?php
 ...
 ?>
		   ...
		   <td align="center"><a href='delete_hostel.php?del=<?php echo $id;?>'> Delete</a></td>
		   
		   
		   <td align="center"><a href='edit_account.php?edit=<?php echo $id;  ?>'>Edit</a></td>
